...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "73f511cc-bc94-4f37-b6aa-2c40ab792309",
  ...
  cs: [
    {
      ...
      load: () => import('../_/load.mjs' /* webpackChunkName: "locale_load_46ts_fd1dac9a" */),
      cache: false
    }
  ],
  en: [
...
const _NVPtp_kLvGXXRyB17awLeA3M0xUJq555xBAic_q8LEo = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const plugins = [
  _NVPtp_kLvGXXRyB17awLeA3M0xUJq555xBAic_q8LEo
];
...
const _0x0O0k = _messagesHandlerCached;

const _SxA8c9 = defineEventHandler(() => {});

const _lazy_8IRolg = () => import('../routes/api/i18n/_locale_.get.mjs');
const _lazy_Zgdk5b = () => import('../routes/api/i18n/invalidate.post.mjs');
const _lazy_sn0BkY = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/i18n/:locale', handler: _lazy_8IRolg, lazy: true, middleware: false, method: "get" },
  { route: '/api/i18n/invalidate', handler: _lazy_Zgdk5b, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_sn0BkY, lazy: true, middleware: false, method: undefined },
  { route: '/_i18n/:locale/messages.json', handler: _0x0O0k, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_sn0BkY, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, createRouter$1 as A, defu as B, getRequestURL as C, getRequestHeader as D, parse as E, klona as F, isEqual as G, setCookie as H, getCookie as I, deleteCookie as J, listener as K, defineEventHandler as a, appRootTag as b, appRootAttrs as c, defineCachedEventHandler as d, appSpaLoaderTag as e, appSpaLoaderAttrs as f, getRouterParam as g, getResponseStatusText as h, getResponseStatus as i, joinRelativeURL as j, appId as k, defineRenderHandler as l, appTeleportTag as m, appTeleportAttrs as n, getQuery as o, createError$1 as p, appHead as q, destr as r, getRouteRules as s, useNitroApp as t, useRuntimeConfig as u, getContext as v, sanitizeStatusCode as w, createHooks as x, executeAsync as y, toRouteMatcher as z };
