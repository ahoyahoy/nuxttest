import { defineComponent, shallowRef, h, resolveComponent, computed, hasInjectionContext, getCurrentInstance, inject, createElementBlock, provide, cloneVNode, Comment, useSSRContext, ref, Suspense, Fragment, createApp, watch, mergeProps, withCtx, createTextVNode, toDisplayString as toDisplayString$1, unref, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, getCurrentScope, Text } from 'vue';
import { v as getContext, w as sanitizeStatusCode, $ as $fetch$1, x as createHooks, y as executeAsync, p as createError$1, z as toRouteMatcher, A as createRouter$1, B as defu, C as getRequestURL, D as getRequestHeader, E as parse$1, r as destr, F as klona, G as isEqual$1, H as setCookie, I as getCookie, J as deleteCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./404-D1qCpg96.mjs')
  },
  {
    name: "404___en",
    path: "/en/404",
  ...
  },
  {
    ...
    component: () => import('./Home-BUUXItnL.mjs')
  },
  {
    name: "home___en",
    path: "/en",
  ...
  {
    name: "grant-thanks___cs",
    path: "/dekujeme",
    meta: { ...__nuxt_page_meta || {}, ...{ "i18n": { "paths": { "en": "/thank-you", "cs": "/dekujeme" } } } },
    component: () => import('./GrantThanks-HpDbMiHr.mjs')
  },
  {
    name: "grant-thanks___en",
    path: "/en/dekujeme",
    component: () => import('./GrantThanks-HpDbMiHr.mjs')
  }
];
...
const localeLoaders = {
  cs: [
    {
      key: "locale_load_46ts_fd1dac9a",
      load: () => import(
        './load-Ch6GVq4f.mjs'
        /* webpackChunkName: "locale_load_46ts_fd1dac9a" */
      ),
      cache: false
    }
  ],
...
async function getLocaleMessagesMergedCached(locale, loaders = []) {
  ...
  for (const loader of loaders) {
    ...
    if (!cached && loader.cache !== false) {
      cacheMessages.set(loader.key, { ttl: Date.now() + -1 * 1e3, value: messages });
    }
...
const rpcTransport_LXFb0DiPRFlbYG9Fgekkd9qFxOv1qkeDL0_E597naOQ = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const vue_query_mAdjlicKbpO1UnAZ7vXXXzGIhtuQpOlfwkLVjVkGKxE = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const plugins = [
  ...
  rpcTransport_LXFb0DiPRFlbYG9Fgekkd9qFxOv1qkeDL0_E597naOQ,
...
const __nuxt_component_0$1 = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const resolvedPath = computed(() => {
      ...
      const resolved = destination != null ? localeRoute2(destination, props.locale) : destination;
    ...
    return () => h(__nuxt_component_0$2, getNuxtLinkProps(), slots.default);
  }
});
const NuxtLink = /* @__PURE__ */ defineNuxtLink({ ...nuxtLinkDefaults, componentName: "NuxtLink" });
const SlpComponent = defineComponent({
  ...
  setup(props, { slots, attrs }) {
    const nuxtApp = useNuxtApp();
    useComposableContext(nuxtApp).localePathPayload;
    const switchLocalePath2 = useSwitchLocalePath(nuxtApp);
    const resolved = computed(() => {
      return encodeURI(switchLocalePath2(props.locale)) || false || "";
    });
    const disabled = computed(() => void 0);
...
const __nuxt_component_1$1 = defineComponent({
  ...
  setup(props, { slots, attrs }) {
    return () => [
      h(Comment, `${"nuxt-i18n-slp"}-[${props.locale}]`),
      h(SlpComponent, { ...attrs, ...props }, slots.default),
      h(Comment, `/${"nuxt-i18n-slp"}`)
    ];
  }
});
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SwitchLocalePathLink = __nuxt_component_1$1;
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "bg-blue-600 text-white shadow-lg" }, _attrs))}><div class="container mx-auto px-4"><div class="flex items-center justify-between h-16"><div class="flex items-center">`);
      ...
      _push(ssrRenderComponent(_component_NuxtLinkLocale, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("navigation.home"))}`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLinkLocale, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("navigation.thanks"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("navigation.thanks")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<div class="flex items-center space-x-2 ml-4"><!--[-->`);
      ssrRenderList(unref(locales), (loc) => {
        _push(ssrRenderComponent(_component_SwitchLocalePathLink, {
          key: loc.code,
          locale: loc.code,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                createTextVNode(toDisplayString$1(loc.code.toUpperCase()), 1)
              ];
            }
          }),
          _: 2
      ...
      _push(`<!--]--></div></div></div><div class="md:hidden"><button class="inline-flex items-center justify-center p-2 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-white"><svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">`);
      ...
      _push(`</svg></button></div></div><div style="${ssrRenderStyle(mobileMenuOpen.value ? null : { display: "none" })}" class="md:hidden"><div class="px-2 pt-2 pb-3 space-y-1 border-t border-blue-500">`);
      _push(ssrRenderComponent(_component_NuxtLinkLocale, {
        to: "/",
      ...
      _push(`<div class="flex space-x-2 px-3 py-2"><!--[-->`);
      ssrRenderList(unref(locales), (loc) => {
        _push(ssrRenderComponent(_component_SwitchLocalePathLink, {
          key: loc.code,
          locale: loc.code,
...
const __nuxt_component_0 = Object.assign(_sfc_main$4, { __name: "AppNavigation" });
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "app" }, _attrs))} data-v-c570f42f>`);
      _push(ssrRenderComponent(_component_AppNavigation, null, null, _parent));
      _push(`<main data-v-c570f42f>`);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c570f42f"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-HrWq2j5x.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-1mSpFlrd.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$2 as a, useNuxtApp as b, useSeoMeta as c, entry$1 as default, useHead as u };
